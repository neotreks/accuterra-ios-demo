...
//  DemoApp
//
//  Created by Rudolf Kopřiva on 08.09.2025.
//  Copyright © 2025 NeoTreks. All rights reserved.
//
...
open class RatingView: UIView {
    ...
    func customInit() {
        if offImage == nil {
            offImage = UIImage(named: "star")
        }
        if onImage == nil {
            onImage = UIImage(named: "star.fill")
        }
        
        if halfImage == nil {
            halfImage = UIImage(named: "star.lefthalf.fill")
        }
