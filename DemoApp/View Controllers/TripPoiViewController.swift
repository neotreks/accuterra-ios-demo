...
class TripPoiViewController: UIViewController {
    ...
    func createNewWithLocation(location: CLLocation) throws {
        ...
        guard let trip = try tripService.getActiveTrip() else {
    ...
    func loadSaved(poiUuid: String) throws {
        ...
        guard let loadedPoi = try tripService.getTripPoiByUuid(poiUuid: poiUuid) else {
        ...
        self.trip = try tripService.getTripByPoiUuid(poiUuid: poiUuid)
...
extension TripPoiViewController : TripMediaCollectionViewCellDelegate {
